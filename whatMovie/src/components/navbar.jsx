...
export default function NavBar({ onPreferenceChange, uniqueGenres }) {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light fixed-top" style={{ padding: "10px", marginBottom: "20px", background: "transparent" }}>
      ...
      {/* Render burger menu icon only on mobile */}
      <div className="navbar-toggler d-lg-none" onClick={handlePreferencesClick}>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav mr-auto">
          <li className="nav-item dropdown">
            <a className="nav-link dropdown-toggle" href="/" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false" style={{ color: "whitesmoke" }}>
              Preferences
            </a>
            <div className={`dropdown-menu ${showPreferences ? 'show' : ''}`} aria-labelledby="navbarDropdown" style={{ minWidth: "auto", width: "50vw", margin: "0 auto", backgroundColor: "#58355E", color: "#E4C3AD", border: "5px solid red", padding: "10px", maxHeight: "70vh", overflowY: "auto" }}>
